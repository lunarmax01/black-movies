            ...
            >
                ...
                <SwiperSlide id="swiperSlide" className="group w-[100%] lg:h-[100vh] md:h-[80vh] sm:h-[65vh] sm:mt-10 xs:h-[36vh] x:h-[30vh] x:mt-16">
                    <div className="lg:w-[80%] w-[100%] h-[100vh] flex flex-col pt-[70px] px-8 py-6 x:px-4 x:pt-16">
                        <div className=" lg:w-[245px] sm:w-[200px] xs:w-[190px] xs:flex sm:flex md:flex lg:flex s:flex xl:flex 2xl:flex justify-between lg:mt-[150px] sm:mt-[55px] md:mt-[90px] md:mb-5 sm:mb-4 xs:mt-[40px] x:w-0 hidden">
                            <h1 className="bg-white lg:text-[18px] md:text-[14px] sm:text-[12px] xs:
                            text-[12px] x:text-10px] x:px-2 x:py-[6px] py-2 px-2 rounded-lg">animarsion</h1>
                            <h1 className="bg-white lg:text-[18px] md:text-[14px] sm:text-[12px] xs:
                            text-[12px] x:text-10px] x:px-2 x:py-[6px] py-2 px-2 rounded-lg">Advanture</h1>
                        </div>
                        <div className="flex">
                ...
                <div className="lg:w-[80%] w-[100%] h-[100vh] flex flex-col pt-[70px] px-8 py-6">
                        ...
                        <p className="lg:text-[19px] md:text-[14px] md:pr-12 sm:text-[13px] xs:text-[10px] x:text-[10px]  text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum, maxime molestiae. Quia tempora distinctio reprehenderit eos corrupti omnis deleniti voluptas? Quasi ratione deleniti in magni sapiente quam perspiciatis enim corrupti odit blanditiis hic, quae dignissimos aliquid tempore iste similique. Molestiae, dignissimos unde ratione ab pariatur.</p>
                        <div className=" flex mt-6 xs:mt-3">
                            <button className="py-2 px-6 flex items-center bg-slate-800 text-white hover:scale-[105%] x:focus:scale-[105%] x:focus:bg-slate-900 rounded-md transition-all x:text-[12px] x:px-3 x:mb-[10px]"><MdOutlineFileDownload className="mr-2 text-xl" />
                                Yuklab olish</button>
                            <button className="py-2 px-6 flex items-center bg-slate-700 ml-4 text-white  hover:scale-[105%] x:focus:scale-[105%] x:focus:bg-slate-900 rounded-md transition-all x:text-[12px] x:px-3 x:mb-[10px]"><SiGoogledisplayandvideo360 className="mr-2 text-xl" />
                                Kino korish</button>
                        </div>
                    </div>
                </SwiperSlide>
